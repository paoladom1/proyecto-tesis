        ...
        <div class="sector2">
            ...
            <div class="formulario">
                ...
                <form class='container-sm' action="{{ route('login') }}" method='POST'>
                    ...
                    @if ($errors->has('email'))
                        <script>
                            alert2('<?php echo $errors->first('email'); ?>', 'danger');
                        </script>
                    @endif
                    <div class="mb-3">
                    ...
                    <div class="row mb-3">
                        <div class="col-8 justify-content-start" style="align-self: center;">
                            <input type="submit" value="Iniciar sesión"
                                style="background-color: #E87B2A; color:white; border: #E87B2A; border-radius: 3px; size: 2em; padding: .5em;">
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="row">
                        <div class="col d-flex justify-content-center">
                            <a href="https://www.facebook.com/UCA.ElSalvador/" target="_blank"><i
                                    class="bi bi-facebook ms-2 me-2 licon fb"></i></a>
                            <a href="https://www.instagram.com/uca_elsalvador" target="_blank"><i
                                    class="bi bi-instagram ms-2 me-2 licon in"></i></a>
                            <a href="https://twitter.com/UCA_ES" target="_blank"><i
                                    class="bi bi-twitter ms-2 me-2 licon tw"></i></a>
                        </div>
                    </div>
                </form>
            </div>
