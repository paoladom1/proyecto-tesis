    ...
    <div class="container-fluid container-general">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #003C71; border-bottom: solid #E87B2A 8px;">
                        ...
                        <button type="button" class="btn-close btn-close-white" style="width: 1em;" data-bs-dismiss="modal"
                            aria-label="Close"
                            onclick="cancelar(); limpiarModalPrincipal(); restablecerDatosTablaEstudiante() "></button>
                    </div>
                        ...
                        <div class='container'>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="cmb1">
                                            ...
                                            @foreach ($facultades as $facultad)
                                                <option value="{{ $facultad->id }}">{{ $facultad->nombre_facultad }}
                                                </option>
                                            @endforeach
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="dropdown">
                                            <button onclick="myFunction(3)" type="button"
                                                class="btn btn-warning dropdown-toggle">Seleccionar</button>
                                            <div id="myDropdown3" class="dropdown-content">
                                                <input type="text" placeholder="Buscar.." id="myInput"
                                                    onkeyup="filterFunction('myDropdown3', 'myInput')">
                                                <div id="Tdocentes" class="scrollable-menu">
                                                    @foreach ($empleados as $empleado)
                                                        <a href="#about"
                                                            onclick="seleccionarEmpleado('<?php echo $empleado->nombre . ' ' . $empleado->apellido; ?>', <?php echo $empleado->id; ?>, 3)">{{ $empleado->nombre }}
                                                            {{ $empleado->apellido }}</a>
                                                    @endforeach
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <input type="text" disabled class="form-control ms-3" id="nombres"
                                                aria-label="Username" aria-describedby="basic-addon1">
                                            <input type="text" hidden disabled class="form-control" id="id"
                                                aria-label="Username" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal" onclick="cancelar()"
                            data-bs-target="#exampleModalToggle" data-bs-toggle="modal"><i class="bi bi-x-circle"></i>
                            Cancelar</button>
                        <button type="button" class="btn btn-success" data-bs-dismiss="modal" onclick="asignarDirector()"
                            data-bs-target="#exampleModalToggle"><i class="bi bi-person-plus-fill"></i> Asignar</button>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #003C71; border-bottom: solid #E87B2A 8px;">
                        ...
                        <button type="button" class="btn-close btn-close-white" style="width: 1em;"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="dropdown">
                                    <button onclick="myFunction(4)" type="button"
                                        class="btn btn-warning dropdown-toggle">Seleccionar</button>
                                    <div id="myDropdown4" class="dropdown-content">
                                        <input type="text" placeholder="Buscar.." id="myInput2"
                                            onkeyup="filterFunction('myDropdown4', 'myInput2')">
                        ...
                        <br>
                        <input hidden type="text" class="form-control" id="idExterno"
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal"
                            data-bs-target="#exampleModalToggle" data-bs-toggle="modal" onclick="cancelar()"><i
                                class="bi bi-x-circle"></i> Cancelar</button>
                        <button type="button" class="btn btn-success" data-bs-dismiss="modal"
                            data-bs-target="#exampleModalToggle" onclick="asignarExterno()"><i
                                class="bi bi-person-plus-fill"></i> Asignar</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="exampleModalToggle" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #003C71; border-bottom: solid #E87B2A 8px;">
                        <h5 class="modal-title" id="exampleModalToggleLabel" style="color: white;">Grupo de trabajo de
                            graduación</h5>
                        <button type="button" class="btn-close btn-close-white" style="width: 1em;"
                            data-bs-dismiss="modal" aria-label="Close" style="color: white"
                            onclick="limpiarModalPrincipal(); restablecerDatosTablaEstudiante() "></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-floating">
                                    <input type="text" id="tema" class="form-control"
                                        ...
                                        placeholder="Ingrese el tema de trabajo de graduacion">
                                    <label for="tema">Tema de trabajo de graduación <span
                                            style="color: red;">(*)</span></label>
                                </div>
                                <br>
                                <label class="form-label">Director(a) del trabajo de graduación <span
                                        style="color: red;">(*)</span></label>
                                <div class="containerToogle">
                                    <div>
                                        <div class="dropdown">
                                            <button onclick="myFunction(1)" type="button" id="seleccionar1"
                                                class="btn btn-warning dropdown-toggle">Seleccionar</button>
                                            <div id="myDropdown1" class="dropdown-content" style="width: 100%;">
                                                <div class="scrollable-menu">
                                                    <a href="#" onclick="eliminarLector(1); myFunction(1)">Quitar
                                                        Elección</a>
                                                    <a data-bs-toggle="modal" data-bs-target="#exampleModal"
                                                        href="#"
                                                        onclick="cambiarBoton(1, 1); restablecerCmb();">UCA</a>
                                                    <a data-bs-toggle="modal" data-bs-target="#exampleModal2"
                                                        href="#"
                                                        onclick="cambiarBoton(2, 1); datosExterno(0);">Externo</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="input-group">
                                            ...
                                            <input type="text" readonly class="form-control" id="nombresD"
                                                name="nombresD" aria-label="Username" aria-describedby="basic-addon1"
                                                style="background-color: white">
                                            <input type="text" readonly style='display: none' class="form-control"
                                                id="idD" name="idD" aria-label="Username"
                                ...
                                <div class="containerToogle">
                                    <div>
                                        <div class="dropdown">
                                            <button onclick="myFunction(2)" type="button" id="seleccionar2"
                                                class="btn btn-warning dropdown-toggle">Seleccionar</button>
                                            <div id="myDropdown2" class="dropdown-content">
                                                <div class="scrollable-menu">
                                                    <a href="#" onclick="eliminarLector(2); myFunction(2)">Quitar
                                                        Elección</a>
                                                    <a data-bs-toggle="modal" data-bs-target="#exampleModal"
                                                        href="#"
                                                        onclick="cambiarBoton(3, 2); restablecerCmb();">UCA</a>
                                                    <a data-bs-toggle="modal" data-bs-target="#exampleModal2"
                                                        href="#"
                                                        onclick="cambiarBoton(4, 2); datosExterno(1);">Externo</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="input-group">
                                            ...
                                            <input type="text" readonly class="form-control" id="nombresL"
                                                name="nombresL" aria-label="Username" aria-describedby="basic-addon1"
                                                style="background-color: white">
                                            <input type="text" readonly style='display: none' class="form-control"
                                                id="idL" name="idL" aria-label="Username"
                                                aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <button class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal45"><i class="bi bi-people"></i> Seleccionar
                                    estudiantes</button>
                                <table class="table table-hover align-middle" style="text-align: center;">
                                    ...
                                    <tbody id="asignados">
                                        <tr id="noDatos1">
                                            <td colspan="3">No hay estudiantes seleccionados <span
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal"
                            onclick="cancelar(); limpiarModalPrincipal(); restablecerDatosTablaEstudiante() "><i
                                class="bi bi-x-circle"></i> Cancelar</button>
                        <button class="btn btn-success" onclick="registrarDatosGrupos();"><i class="bi bi-save"></i>
                            <span id="btnCrearGrupo">Crear grupo</span></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="table-responsive">
            ...
            <div id="tablaGruposContainer">
                <div class="container" style="margin-right: 0">
                    <form class="row searchFilter" action="/grupoTrabajo" method="GET">
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input id="ciclo" name="ciclo" type="text" class="form-control"
                                    style="margin-right: 20px" placeholder="Ciclo" onkeyup="isEmpty()">

                                <input id="anio" name="anio" type="text" class="form-control"
                                    style="margin-right: 20px" placeholder="Año" onkeyup="isEmpty()">

                                <div class="input-group-btn">

                                    <button id="search" type="submit" class="btn btn-secondary btn-search"
                                        disabled><span class="glyphicon glyphicon-search">&nbsp;</span> <span
                                            class="label-icon">Buscar</span></button>
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <tbody>
                        @foreach ($filtro_grupos as $dato)
                            <tr>
                                ...
                                <td style="width: 20%"><button class="btn btn-primary" type="button"
                                        data-bs-toggle="modal" data-bs-target="#exampleModalToggle"
                                        onclick="mostrarDatosModalPrincipal(<?php echo $dato->id; ?>)"
                                        style="color: white">Editar</button>{{--  <button class="btn btn-danger ms-1" onclick="">Eliminar</button> --}}</td>
                            </tr>
                        @endforeach
                        @if (count($filtro_grupos) == 0)
                ...
                <div class="paginacionAD">
                    @if ($filtro_grupos->total() != 0)
                        <div>
                            <p>Resultados del {{ $filtro_grupos->firstItem() }} al {{ $filtro_grupos->lastItem() }} de
                                {{ $filtro_grupos->total() }}</p>
                        </div>
                    @endif
                    <div id="paginacionGrupos">
                        {{ $filtro_grupos->links('pagination::bootstrap-4') }}
                    </div>
                </div>
            </div>
        </div>
        <a class="float-button btn-float-2" data-bs-toggle="modal" href="#exampleModalToggle" role="button"
            data-backdrop="false" onclick="$('#btnCrearGrupo').text('Crear Grupo');  mostrarEleccionEstudiante();"><i
                class="bi bi-people-fill float-icon" style="border-radius: 100%"></i></a>
        <br>

        <!--------------------------------------------------Modal para estudiantes----------------------------------------->

        <div class="modal fade" id="exampleModal45" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #003C71; border-bottom: solid #E87B2A 8px;">
                        ...
                        <button type="button" class="btn-close btn-close-white" style="width: 1em;"
                            data-bs-dismiss="modal" aria-label="Close"
                            onclick="limpiarModalPrincipal(); $('#buscadorEstuiante').text('Nombre'); banderaBusqueda = 1;cancelar();restablecerTablaEstudiante();restablecerDatosTablaEstudiante(); restablecerDatosTablaEstudiante();"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p>Puede seleccionar a <span
                                        id="numEstudiante">{{ $configuraciones->numero_integrantes }}</span> estudiantes
                                </p>
                                ...
                                <div class="input-group mb-3 dropEstudiante">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="#"
                                                onclick="$('#buscadorEstuiante').text('Nombre'); banderaBusqueda=1;">Nombre</a>
                                        </li>
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                        <li><a class="dropdown-item" href="#"
                                                onclick="$('#buscadorEstuiante').text('Apellido'); banderaBusqueda=2">Apellido</a>
                                        </li>
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                        <li><a class="dropdown-item" href="#"
                                                onclick="$('#buscadorEstuiante').text('Carnet'); banderaBusqueda=3;">Carnet</a>
                                        </li>
                                    </ul>
                                    <input type="search" class="form-control" id="buscadorTablaE"
                                        placeholder="Digite su criterio de busqueda">
                                    <button class="btn btn-secondary" type="button" id="button-addon2"
                                        onclick="buscadorEstudiante()"><i class="bi bi-search"></i></button>
                                </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" data-bs-target="#exampleModalToggle"
                            data-bs-toggle="modal"
                            onclick="$('#buscadorEstuiante').text('Nombre'); banderaBusqueda = 1;cancelar();restablecerTablaEstudiante();"><i
                                class="bi bi-person-plus-fill"></i> Aceptar</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        const estudiantesPag = (page) => {
            $.ajax({
                ...
                data: {
                    "page": page,
                    "vista": "director.tablaEstudiante",
                    "buscadorE": Busqueda,
                    "tipoBusqueda": banderaConstante,
                    "idGrupo": $("#idGrupo").val()
                },
                dataType: 'json',
                success: function(r) {
        ...
        function agregarCmb2(docentes) {
            ...
            docentes.forEach(element => {
                var div2 =
                    `<a href="#about" onclick="seleccionarEmpleado('${element['nombre']} ${element['apellido']}', '${element['id']}', 3)">${element['nombre']} ${element['apellido']}</a>`;
        ...
        function agregarToogleExterno(datosE, tipoExterno) {
            ...
            datosE.forEach(element => {
                var div2 =
                    `<a href="#about" onclick="datosExterno('', ${element['id']})">${element['nombre']} ${element['apellido']}</a>`;
                var div = document.createElement('div');
                div.innerHTML = div2;
            ...
            if (tema.trim() != "" && integrantes.length != 0 && idAsesor.trim() != "") {
                $.ajax({
                    ...
                    success: function(r) {
                        ...
                        if (idGrupo == "") {
                            alertPersonalizado("Grupo de trabajo de graduación registrado con exito!",
                                'success', 1, ++contadorAlerta);
                        } else {
                            alertPersonalizado("Grupo de trabajo de graduación modificado con exito!",
                                'success', 1, ++contadorAlerta);
                        }
                ...
                alertError("Debe de llenar el campo, Tema de trabajo de graduación!", 'danger', 2, 'liveAlertPlaceholder4',
                    1);
            } else if (idAsesor.trim() == "") {
                alertError("Debe de seleccionar a un Director del trabajo de graduación!", 'danger', 2,
                    'liveAlertPlaceholder4', 1);
            } else if (integrantes.length == 0) {
                alertError("Debe de seleccionar al menos a un estudiante para el grupo de trabajo!", 'danger', 2,
                    'liveAlertPlaceholder4', 1);
            }
        }
            ...
            $.ajax({
                ...
                success: function(r) {
                    ...
                    if (r['asesor_interno'] != null) {
                        ...
                        $("#nombresD").val(r['asesor_interno']['nombre'] + " " + r['asesor_interno'][
                            'apellido'
                        ]);
                        $('#tipoAsesor').val(0);
                        ...
                        $("#nombresD").val(r['asesor_externo']['nombre'] + " " + r['asesor_externo'][
                            'apellido'
                        ]);
                        $('#tipoAsesor').val(1);
                    }
                    ...
                    if (r['lector_interno'] != null) {
                        ...
                        $("#nombresL").val(r['lector_interno']['nombre'] + " " + r['lector_interno'][
                            'apellido'
                        ]);
                        $('#tipoLector').val(0);
                        ...
                        $("#nombresL").val(r['lector_externo']['nombre'] + " " + r['lector_externo'][
                            'apellido'
                        ]);
                        $('#tipoLector').val(1);
                    }
        ...
        function isEmpty() {
            if (document.getElementById('anio').value === '' || document.getElementById('ciclo').value === '') {
