    ...
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home"
                type="button" role="tab" aria-controls="nav-home" aria-selected="true">DIRECTORES DE CARRERA</button>
        </div>
            ...
            <thead class=" thead-dar"
                ...
                <tbody>
                    <tr style="text-align: center">
                        <td style="width: 20%;">Enmanuelle</td>
                        <td style="width: 20%">Araujo</td>
                        <td style="width: 20%">INGENIERIA EN INFORMATICA</td>
                        <td style="width: 20%">
                            <a href="{{ url('/editarDirector')}}" class="btn btn-warning btn-sm" type="button" title="Edit">
