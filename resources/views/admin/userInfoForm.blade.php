    ...
    <div class="container-fluid container-general">
        ...
        <div class="container-fluid container-general">
            ...
            <form method="POST" action="/actualizarUsuario/{{ $usuario->id }}" class="row g-3">
                ...
                <div class="col-md-6"></div>
                <div class="col-md-6">
                    <label for="inputEmail4" class="form-label">Fecha limite</label>
                    <input type="date" class="form-control" name="fecha_limite" value="{{ $usuario->fecha_limite }}"
                        class="@error('fecha_limite') is-invalid @enderror"> @error('fecha_limite')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>

                <div class="col-12">
                    <a href="{{ url('/mostrarUsuario') }}"><button type="button" class="mb-3 btn btn-danger"><i
