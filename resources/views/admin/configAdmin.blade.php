...
<nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
          <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">CONFIGURACION</button>
        </div>
    </nav>
...
<div class="table-responsive">
    ...
    <div id="tablaUsuariosContainer">
        <table class="table table-hover align-middle fuente-general fuente general" id="tableUserDashboard"">
            ...
            <tbody>
                <tr>
                    <td style="width: 30%">23/06/2023</td>
                    <td style="width: 30%">23/08/2023</td>
