...
<body>
    <nav class="navGral d-flex justify-content-between" id="nav">
        ...
        <div class="dropdown" id="user-settings">
            <button class="btn btn-secondary dropdown-toggle" type="button" id="user-btn" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <img src="/{{ auth()->guard('admin')->user()->foto }}" id="profile"
                    style="width: 3em; height: 3em; border-radius: 100%;" />
            </button>
            <div class="dropdown-menu" aria-labelledby="user-btn">
                <a class="dropdown-item user-btn-name" href="#"
                    style="width: 100%;">{{ auth()->guard('admin')->user()->email }}</a>
        ...
        <div id="navMenu">
            ...
            @if (auth()->guard('admin')->user()->tipo_usuario_id == 1)
                <ul class="list-unstyled components">
                    ...
                    <li> <a href="{{ url('/glosario') }}"><i class="bi bi-journal-bookmark-fill"></i> Glosario</a>
                    </li>
                    <li> <a href="{{ url('/referencias') }}"><i class="bi bi-list-columns-reverse"></i> Referencias</a>
                    </li>
            ...
            @elseif (auth()->guard('admin')->user()->tipo_usuario_id == 2)
                <ul class="list-unstyled components">
                    <li>
                        <a href="{{ url('/menudirector') }}" style="font-size: 1.3rem"><i
                                class="bi bi-house-door me-2"></i>Menu Principal</a>
                        <hr>
                    </li>
                    <li> <a href="{{ url('/externo') }}" style="font-size: 1.3rem"><i
                                class="fa-solid fa-address-card me-2"></i><span>Directores y Lectores</span></a> </li>
            ...
            @elseif (auth()->guard('admin')->user()->tipo_usuario_id == 3)
                <ul class="list-unstyled components">
                    <li>
                        <a href="{{ url('/menuadmin') }}" style="font-size: 1.3rem"><i
                                class="bi bi-house-door me-2"></i>Menu Principal</a>
                        <hr>
                    </li>
                    <li><a href="{{ url('/mostrarUsuario') }}" style="font-size: 1.3rem"><i
                                class="bi bi-person-check-fill"></i> <span>Usuarios</span></a></li>
                    <li><a href="{{ url('/employeeInfo') }}" style="font-size: 1.3rem"><i
                                class="bi bi-person-badge"></i> <span>Empleados</span></a></li>
                    <li><a href="{{ url('/studentInfo') }}" style="font-size: 1.3rem"><i
                                class="bi bi-person-rolodex"></i> <span>Estudiantes</span></a></li>
                    <li><a href="{{ url('/directorInfo') }}" style="font-size: 1.2rem"><i
                                class="bi bi-person-lines-fill"></i> <span>Directores de carrera</span></a></li>
                    <hr>
                </ul>
            @endif
        </div>
