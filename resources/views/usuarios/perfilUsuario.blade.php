...
@section('content')
        ...
        <form action="{{ url('/cambiarDatos') }}" enctype="multipart/form-data" method="post">
            ...
            <div class="container-fluid" style="background-color: #e3eef5; border: 1px #003C71 solid;">
                <div class="row" style="background-color: #003C71; border-bottom: solid #E87B2A 8px; ">
                    <p class="mt-3" style="color: white; font-size: 1.5em"><i class="bi bi-person-circle me-3"></i>PERFIL
                        DE USUARIO</p>
                </div>
                <div class="row d-flex flex-column align-items-center justify-content-center mt-4">
                    @if (session('mensaje'))
                        @if (session('mensaje')[0] != '' || session('mensaje')[1] != '' || session('mensaje')[2] != '')
                            <div class="container">
                ...
                <div class="row mt-4">
                    <div class="col">
                        <div class="form-group form-floating">
                            <input type="text" class="form-control" id="floatingName" placeholder="Ingrese el nombre"
                                name="nombre" value="{{ $usuario->nombre }}"
                                @if (auth()->guard('admin')->user()->tipo_usuario_id != 3) disabled @endif>
                ...
                <div class="row mt-3">
                    <div class="form-floating">
                        <input type="email" class="form-control" id="floatingEmail" placeholder="Ingrese el correo"
                ...
                <div class="row d-flex justify-content-between mt-4 mb-4 ms-3 me-3">
                    <button type="button" class="me-3 btn btn-danger" data-toggle="modal" data-target="#modal-profile"
                        style="width: 45%;"><i class="bi bi-x-circle me-2"></i>Descartar cambios</button>
                    <button type="submit" class="ms-3 btn btn-success" style="width: 45%"><i
                            class="bi bi-check-circle me-2"></i>Guardar cambios</button>
                </div>
            </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="modal-profile" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #003C71; border-bottom: solid #E87B2A 8px;">
                    <h5 class="modal-title" style="color: white; font-size: 1.75em;" id="exampleModalLongTitle">
                        Descartando cambios</h5> <!-- cambiar esta parte-->
                    <button type="button" class="btn-close btn-close-white" style="width: 1em;" data-dismiss="modal"
                        aria-label="Close">
                    </button>
                </div>
