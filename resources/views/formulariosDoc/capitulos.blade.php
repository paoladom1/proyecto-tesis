...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="nombreCap" aria-describedby="basic-addon3">
        ...
        <div class="row">
            <div class="col-md-4">
                <button style="display:none" class="btn btn-success" id="guardarOrden" onclick="modificarOrden()">Guardar orden</button>
            </div>
        </div>
    </div>
